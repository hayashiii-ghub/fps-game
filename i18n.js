...
const I18N_STRINGS = {
  ja: {
    ...
    'controls': 'WASD 移動　SHIFT ダッシュ　C しゃがみ　SPACE ジャンプ　左 射撃　右/V 照準<br>R リロード　G グレネード　F キット　Q/E 武器切替　ESC ポーズ',
  ...
  en: {
    ...
    'controls': 'WASD move · SHIFT sprint · C crouch · SPACE jump · LMB fire · RMB/V aim<br>R reload · G grenade · F medkit · Q/E weapon · ESC pause',
