...
const I18N_STRINGS = {
  ja: {
    ...
    'map.tokyo.desc': '夕暮れのオフィス街。ピロティと街路樹、中央分離帯。<br>STAGE 4 は夜に沈む ― 灯りを頼れ。',
    ...
    'controls': 'WASD 移動　SHIFT ダッシュ　C しゃがみ　SPACE ジャンプ　左 射撃　右/V 照準<br>R リロード　G グレネード　F キット　Q/E・1-9 武器切替　ESC ポーズ',
    ...
    'stage.4.title.neon': 'STAGE 4 ― ネオン',
    'stage.4.sub.neon': '日没 ― 視界不良。光を背にするな',
    'stage.4.theme.neon': 'ネオン',
    'stage.4.title.night': 'STAGE 4 ― 夜',
    'stage.4.sub.night': '日没 ― 視界不良。灯りを頼れ',
    'stage.4.theme.night': '夜',
    'stage.5.title': 'STAGE 5 ― 最終防衛',
    'stage.5.sub': '最終山場 ― 精鋭・狙撃・突撃の混成',
    'stage.5.theme': '最終防衛',
    'weather.squall': 'スコール ― 視界不良。音に頼れ',
    'weather.hurricane': 'ハリケーン ― 視界不良。音に頼れ',
    'weather.neon': 'ネオン ― 視界不良。光を背にするな',
    'weather.night': '夜 ― 視界不良。灯りを頼れ',
  ...
  en: {
    ...
    'map.tokyo.desc': 'Office district at dusk. Pilotis arcades, street trees, medians.<br>Night falls at STAGE 4 ― follow the lights.',
    ...
    'controls': 'WASD move · SHIFT sprint · C crouch · SPACE jump · LMB fire · RMB/V aim<br>R reload · G grenade · F medkit · Q/E · 1-9 weapon · ESC pause',
    'note.audio': '※ Audio on · Pointer lock required',
    'audio.mute': 'MUTE',
    'audio.volume': 'VOL',
    'audio.aria': 'Audio',
    'look.sens': 'SENS',
    'look.aria': 'Look sensitivity',
    ...
    'stage.4.title.neon': 'STAGE 4 ― Neon',
    'stage.4.sub.neon': 'Nightfall ― low visibility. Stay out of the light',
    'stage.4.theme.neon': 'Neon',
    'stage.4.title.night': 'STAGE 4 ― Night',
    'stage.4.sub.night': 'Nightfall ― low visibility. Follow the lights',
    'stage.4.theme.night': 'Night',
    ...
    'weather.neon': 'Neon ― low visibility. Stay out of the light',
    'weather.night': 'Night ― low visibility. Follow the lights',
